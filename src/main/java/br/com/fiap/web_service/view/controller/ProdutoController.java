...
public class ProdutoController {
  ...
  public ResponseEntity<List<ProdutoResponse>> obterTodos() {
    ...
    List<ProdutoResponse> resposta = produtos.stream().map(produtoDto -> mapper
        .map(produtoDto, ProdutoResponse.class))
  ...
  public ResponseEntity<Optional<ProdutoResponse>> obterPorId(@PathVariable Integer id) {
    ...
    return new ResponseEntity<>(Optional.of(new ModelMapper().map(dto.get(), ProdutoResponse.class)), HttpStatus.OK);
